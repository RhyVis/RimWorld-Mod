...
namespace Nova
{
  ...
  public class CompGasEmit : ThingComp
  {
    ...
    public override void PostSpawnSetup(bool respawningAfterLoad)
    {
      ...
      if (_powerTrader == null) Log.Error("[Nova] CompPowerTrader needed for CompGasEmit!");
    }
    ...
    public override IEnumerable<Gizmo> CompGetGizmosExtra()
    {
      ...
      {
        defaultLabel = "Nova_CompGasEmit_Gizmo_Label".Translate(),
        defaultDesc = "Nova_CompGasEmit_Gizmo_Desc".Translate(),
