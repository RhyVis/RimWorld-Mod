...
public class CompHediffGiver : ThingComp
{
  ...
  private TaggedString GizmoLabel => _factionType switch
  {
    0 => "Nova_CompHediffGiver_Gizmo_LabelA".Translate(),
    1 => "Nova_CompHediffGiver_Gizmo_LabelB".Translate(),
    2 => "Nova_CompHediffGiver_Gizmo_LabelC".Translate(),
    3 => "Nova_CompHediffGiver_Gizmo_LabelD".Translate(),
    4 => "Nova_CompHediffGiver_Gizmo_LabelE".Translate(),
    _ => "ERR"
  };

  private Texture2D GizmoIcon => _factionType switch
  {
