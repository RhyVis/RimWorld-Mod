...
public class Building_WealthCovert : ThingClass
{
  ...
  public override IEnumerable<Gizmo> GetGizmos()
  {
    ...
    {
      defaultLabel = "Nova_CompResourceCovert_GizmoA_Label".Translate(AutoCovertString),
      defaultDesc = "Nova_CompResourceCovert_GizmoA_Desc".Translate(AutoCovertString),
    ...
    yield return new Command_Toggle
    {
      defaultLabel = "Nova_CompResourceCovert_GizmoAP_Label".Translate(AutoPlaceString),
      defaultDesc = "Nova_CompResourceCovert_GizmoAP_Desc".Translate(AutoPlaceString),
      icon = TexCommand.DesirePower,
      isActive = () => _autoPlace,
      toggleAction = delegate
      {
    ...
    {
      defaultLabel = "Nova_CompResourceCovert_Gizmo_Label".Translate(),
      defaultDesc = "Nova_CompResourceCovert_Gizmo_Desc".Translate(),
      icon = TexCommand.ForbidOff,
      action = DoCovert
    };
    yield return new Command_Action
    {
      defaultLabel = "Nova_CompResourceCovert_GizmoP_Label".Translate(),
      defaultDesc = "Nova_CompResourceCovert_GizmoP_Desc".Translate(),
      icon = TexCommand.ForbidOff,
      action = delegate { TryPlace(true); }
    };
    yield return new Command_Action
    {
      defaultLabel = "Nova_CompResourceCovert_Gizmo1_Label".Translate(ModeLabel),
      defaultDesc = "Nova_CompResourceCovert_Gizmo1_Desc".Translate(),
  ...
  public override string GetInspectString()
  {
    ...
    sb.Append("Nova_CompResourceCovert_Info".Translate(_leftoverSilverValue));
    return sb.ToString();
  }
  ...
  private void DoCovert()
  {
    ...
    MoteMaker.ThrowText(
      ...
      Map, "Nova_CompResourceCovert_Mote".Translate(silverValue));
